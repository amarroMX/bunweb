    ...
    return (
        <div className="flex flex-col items-center justify-between gap-24 py-16">
            <div className="inline-block  text-center space-y-1">
                <h1 className="text-[#00623B] text-5xl md:text-8xl font-black capitalize">excellent café</h1>
                <h2 className="text-white text-3xl md:text-6xl font-black capitalize">bonne humeur</h2>
            </div>
            <div className="relative max-w-[550px] mx-2">
